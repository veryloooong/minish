...
int print_entry(const char *filepath, const struct stat *info, const int typeflag,
                struct FTW *pathinfo) {
  ...
  printf("%04d-%02d-%02d %02d:%02d:%02d", mtime.tm_year + 1900, mtime.tm_mon + 1, mtime.tm_mday,
